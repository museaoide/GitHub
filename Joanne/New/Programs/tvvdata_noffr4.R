...
tvvData_noffr4<-function(countries, data, commdata, commIndexWeights =c(1/4, 1/4, 1/4, 1/4), freq=4,nLags=5,SecondaryBrk=c(0, 1984, 1998.75, 2007.75, 2015), begin=NULL, terminate=NULL, credittype="apa", powerof=1){
	
##Function: Stacks country data (log defl, log rgdp, 
##short term rate, log credit2gdp, log real property prices, 
##into an annual time series that begins with year 1
##Differs in that exogenous variables include lagged 
##endogenous variables multiplied by country dummies
##
##Input: 
...
##
#Prep X Matrix--matrix of country dummies + country dummies * macro data
###	
	#start<-0
