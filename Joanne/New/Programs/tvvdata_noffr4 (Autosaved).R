...
tvvData_noffr4<-function(countries, data, commdata, commIndexWeights =c(0, 0, 1, 0), freq=4,nLags=5,SecondaryBrk=c(0, 1984, 1998.75, 2007.75, 2015), begin=NULL, terminate=NULL, credittype="apa", powerof=1){
